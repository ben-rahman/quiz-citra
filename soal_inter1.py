...
# HEADER
# -------------------------------
st.markdown("<h1 style='text-align:center; color:#0066cc;'>UJIAN / TUGAS - PPS</h1>", unsafe_allow_html=True)
...
if soal_index >= len(soal_list):
    if st.session_state.phase == "teori":
        ...
        # -------------------------------
        # PESAN WA + COPY BUTTON (JALAN DI CLOUD)
        # -------------------------------
...
Terima kasih, Pak 🙏"""
        ...
        # buat komponen HTML interaktif dengan tombol copy
        html_code = f"""
